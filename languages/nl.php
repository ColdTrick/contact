...
return [
  ...
  'contact:form:error' => 'Controleer de lege verplichte velden (gemarkeerd in rood)',
  'contact' => 'Contact',
  ...
  'contact:settings:wg_contact:label' => 'Contact menu item en pagina weergeven in walled garden mode',
  'contact:settings:recipient:label' => 'Contact formulier ontvanger',
  'contact:settings:contact_description:label' => 'Pagina text: ',
